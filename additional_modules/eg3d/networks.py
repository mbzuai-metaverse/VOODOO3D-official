...
import torch
from additional_modules.eg3d.networks_stylegan2 import Generator as StyleGAN2Backbone, FullyConnectedLayer
from additional_modules.eg3d.superresolution import SuperresolutionHybrid8XDC
...
class TriPlaneGenerator(torch.nn.Module):
    ...
    def synthesis(self, ws, c, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
        ...
        return {'image': sr_image, 'image_raw': rgb_image, 'image_depth': depth_image, 'feature_image': feature_image, 'planes': planes}
